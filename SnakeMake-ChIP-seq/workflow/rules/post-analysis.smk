rule preseq_lc_extrap:
    ...
    wrapper:
        config["warpper_mirror"] + "bio/preseq/lc_extrap"
...
rule collect_multiple_metrics:
    ...
    wrapper:
        config["warpper_mirror"] + "bio/picard/collectmultiplemetrics"
...
rule genomecov:
    ...
    wrapper:
        config["warpper_mirror"] + "bio/bedtools/genomecov"
...
rule bedGraphToBigWig:
    ...
    params:
        ""
    wrapper:
        config["warpper_mirror"] + "bio/ucsc/bedGraphToBigWig"
...
rule compute_matrix:
    ...
    wrapper:
        config["warpper_mirror"] + "bio/deeptools/computematrix"
...
rule plot_profile:
    ...
    params:
        ""
    wrapper:
        config["warpper_mirror"] + "bio/deeptools/plotprofile"
...
rule plot_heatmap:
    ...
    params:
        ""
    wrapper:
        config["warpper_mirror"] + "bio/deeptools/plotheatmap"
